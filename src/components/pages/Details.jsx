...
function Details() {
    ...
    useEffect(() => {
        ...
        fetch(`https://fakestoreapi.com/products/${routeParams.id}`)
            .then((res) => res.json())
            .then((json) => {
                setProductData(json);
            });
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                        ...
                        <div className="md:py-8">
                            ...
                            <div className="mb-5 md:mb-3">
                                <span className="mb-0.5 inline-block text-gray-800" style={{ position: 'relative', top: '-20px' }}>
                            ...
                            {/* name - end */}
                            {/* rating - start */}
                            <div className="mt-5 mb-6 flex items-center md:mb-10">
                                ...
                                <span className="ml-2 text-sm text-gray-500">{productData.rating ? productData.rating.rate : ""}</span>
                                <a
                                    href="#"
                            ...
                            <div className="mb-8 md:mb-10">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    ...
                                    <span className="flex h-8 w-12 cursor-default items-center justify-center rounded-md border border-[#FB2E86] bg-[#FB2E86] text-center text-sm font-semibold text-white">
                                        M
                                    </span>
                                    <button
                                        type="button"
                            ...
                            <div className="flex gap-2.5">
                              <NavLink to={"/cart"}>
                              <a
                                    className="inline-block flex-1 rounded-lg bg-[#FB2E86] px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 sm:flex-none md:text-base"
                                >
                                    Add to cart
                                </a>
                              </NavLink>
