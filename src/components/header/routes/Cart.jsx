...
function Cart() {
  ...
  <div className="mx-auto max-w-screen-lg px-4 md:px-8">
    ...
    <div className="flex flex-col items-end gap-4">
      ...
      <button className="inline-block rounded-lg bg-[#FB2E86] px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-300 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">
        Check out
      </button>
    </div>
    {/* totals - end */}
